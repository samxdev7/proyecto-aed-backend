...
/**
 * DTO de entrada para creación de viajes por administrador (Endpoint C3 - POST /viajes).
 * Derivado de RF2.
 */
public record CrearViajeRequestDto(
    ...
    @Future(message = "La fecha y hora de ida debe ser en el futuro")
